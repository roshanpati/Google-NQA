...
# Modifications Copyright (C) 2019 Sashank Gondala, Sagarika Srishti, Roshan Pati
#
...
def load_and_cache_examples(filename, distil, tokenizer, evaluate=False, is_nqa=True):
    """
    ...
    if is_nqa:
        examples = read_NQA_examples(filename)
    else:
        examples = read_squad_examples(filename, not evaluate, True)
